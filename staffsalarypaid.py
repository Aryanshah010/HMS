...
def salarypg():
    ...
    def search_staff():
        ...
        try:
            ...
            if staff_data:
                ...
                # Load and display fee records for this staff
    ...
    def load_fee_records(phoneNum):
        try:
            ...
            for record in fee_records:
                # Explicitly convert amount to string
                amount_paid = str(record[1])
    ...
    def save():
        try:
            ...
            if not (phoneNum and salary_date and amount):
            ...
            if messagebox.askyesno("", "Do you want to save the fee of this staff?"):
                ...
                AmountPaidentry.delete(0, END)

                # Show success message
                messagebox.showinfo("", "Staff fee saved successfully!")
                menupg()
    ...
    search_button = Button(win, text="Search", bg="#00C8D8", fg="white", font="verdana 14", image=search_icon, borderless=1,
                           compound="left", command=search_staff)
